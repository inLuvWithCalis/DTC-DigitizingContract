              ...
              <div className="flex items-start gap-3">
                ...
                <div className="space-y-1">
                  ...
                  <AlertDescription className="text-xs sm:text-sm text-amber-800 dark:text-amber-300 leading-relaxed">
                    Tài khoản của bạn vừa được khởi tạo hoặc đặt lại mật khẩu
                    bởi quản trị viên. Để đảm bảo an toàn thông tin và quyền
                    riêng tư, bạn cần thiết lập mật khẩu mới trước khi tiếp tục
                    sử dụng các chức năng nghiệp vụ.
                  </AlertDescription>
                </div>
              </div>
            </Alert>
              ...
              <Card className="border-border/80 shadow-sm gap-0">
                ...
                <CardContent className="space-y-3 pt-0 text-xs text-muted-foreground">
                  ...
                  <div className="rounded-xl border border-border/50 bg-muted/20 p-3 text-[11px] leading-relaxed mt-2">
                    ...
                    Nếu không nhớ mật khẩu cũ, hãy liên hệ Quản trị viên hệ
                    thống để yêu cầu cấp lại mật khẩu tạm thời.
                  </div>
                </CardContent>
              </Card>
            </div>
