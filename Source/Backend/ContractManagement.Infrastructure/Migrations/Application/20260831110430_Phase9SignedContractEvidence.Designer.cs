...
namespace ContractManagement.Infrastructure.Migrations.Application
{
    ...
    [Migration("20260831110430_Phase9SignedContractEvidence")]
    partial class Phase9SignedContractEvidence
    {
        /// <inheritdoc />
                    ...
                    b.ToTable("tbl_ContractAudit", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_tbl_ContractAudit_Subject", "([SubjectType] IS NULL AND [SubjectId] IS NULL) OR ([SubjectType] IN ('Contract', 'ContractVersion', 'NegotiationComment', 'CustomerAccessLink', 'CustomerOtpChallenge', 'CustomerAccessSession', 'ApprovalRequest', 'SignedEvidence') AND [SubjectId] > 0)");
