...
export const contractCompletionApi = {
  ...
  setPaymentMilestoneStatus: (contractId: number, versionId: number, milestoneId: number, values: { currentVersionId: number; contractRowVersion: string; versionRowVersion: string; milestoneRowVersion: string; status: ContractPaymentMilestoneStatus }) =>
    axiosClient.put<unknown, ContractPaymentMilestoneResponse>(`${BASE_URL}/${contractId}/versions/${versionId}/payment-milestones/${milestoneId}/status`, values),
