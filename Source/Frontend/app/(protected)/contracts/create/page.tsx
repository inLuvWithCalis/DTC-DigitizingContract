...
export default function CreateContractPage() {
  ...
  const handleCreateMock = () => {
    toast.success("Đã tạo hợp đồng nháp mock. Chờ backend POST API để lưu thật.");
        ...
        <div className="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
          <div>
            ...
            <p className="mt-2 max-w-3xl text-sm text-muted-foreground">
              ...
              và điều khoản. Khi có POST API, phần submit sẽ được nối vào backend.
            </p>
          </div>
        </div>
              ...
              {currentStep === 3 && (
                <div className="space-y-5">
                  <Alert>
                    ...
                    <AlertTitle>Hợp đồng sẽ được tạo ở trạng thái Bản nháp</AlertTitle>
                    <AlertDescription>
