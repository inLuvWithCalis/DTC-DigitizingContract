...
namespace ContractManagement.Infrastructure.Migrations.Application
{
    ...
    [Migration("20260805030556_Phase6_Slice05NegotiationCommentsAndLifecycle")]
    partial class Phase6_Slice05NegotiationCommentsAndLifecycle
    {
        /// <inheritdoc />
                    ...
                    b.ToTable("tbl_ContractNegotiationComment", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_tbl_ContractNegotiationComment_RecordedByEmployeeId", "[RecordedByEmployeeId] > 0");

                            t.HasCheckConstraint("CK_tbl_ContractNegotiationComment_Source", "[Source] = 'ExternalFeedback'");
                    ...
                    b.ToTable("tbl_ContractNegotiationCommentEvent", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_tbl_ContractNegotiationCommentEvent_EmployeeId", "[EmployeeId] > 0");
